...
opt_path = 'options/train_DESM_IO_simulation.yml'
...
def main():
    ...
    train_loader, val_loader = gen_prepared_dataloader(read_dir_train=read_dir_train, read_dir_val=read_dir_val, num_file_train=opt['num_train'], 
                                                                    ...
                                                                    batch_size=opt['train']['batch_size'], device=device, num_workers=opt['num_workers'], read_lifetime_flag=False)
